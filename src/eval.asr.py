...
from data import EvalAudioASRDataLoader, EvalAudioASRDataset
...
parser.add_argument('--s1_json', type=str, default=None,
                    help='')
...
def main(args):
    ...
    if args.continue_from == '':
    	return
    ev_dataset = EvalAudioASRDataset(args.train_dir, args.s1_json, args.batch_size,
                              sample_rate=args.sample_rate)

    ev_loader = EvalAudioASRDataLoader(ev_dataset, batch_size=1,
    ...
    # solver
    solver = Solver(data, model, optimizier, args, DEVICE, ev=True)
