...
from data import AudioAllDataLoader, AudioAllDataset
...
def main(args):
    # Construct Solver
    # data
    tr_dataset = AudioAllDataset(args.train_dir, args.batch_size,
                              sample_rate=args.sample_rate)

    tr_loader = AudioAllDataLoader(tr_dataset, batch_size=1,
    ...
    # solver
    solver = Solver(data, sep_model, asr_model, sep_optimizier, asr_optimizier, args, DEVICE)
    solver.train()
