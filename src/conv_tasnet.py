...
class ConvTasNet(nn.Module):
    ...
    def forward(self, mixture):
        ...
        #print("output_encoder", mixture_w)
        est_mask = self.separator(mixture_w)
        #print("output_sep", est_mask)
        est_source = self.decoder(mixture_w, est_mask)
        #print("output_dec", est_source)
    ...
    @classmethod
    def load_model(cls, path, state_dict='state_dict'):
        # Load to CPU
        package = torch.load(path, map_location=lambda storage, loc: storage)
        model = cls.load_model_from_package(package, state_dict)
        return model

    @classmethod
    def load_model_from_package(cls, package, state_dict='state_dict'):
    ...
    @staticmethod
    def serialize(model, optimizer, epoch, tr_loss=None, cv_10_loss=None, cv_5_loss=None, cv_0_loss=None, cv_m5_loss=None):
        package = {
            # hyper-parameter
        ...
        if tr_loss is not None:
            ...
            package['cv_10_loss'] = cv_10_loss
            package['cv_5_loss'] = cv_5_loss
            package['cv_0_loss'] = cv_0_loss
            package['cv_m5_loss'] = cv_m5_loss
        return package
...
class Encoder(nn.Module):
    ...
    def forward(self, mixture):
        ...
        #print('enc', self.conv1d_U.state_dict())
        return mixture_w
